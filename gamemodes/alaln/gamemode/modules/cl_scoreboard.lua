	...
	Think = function(self)
		...
		if self.Muted == nil or self.Muted ~= self.Player:IsMuted() then
			...
			self.Mute.PaintOver = function(s, w, h)
				...
				draw.SimpleText(math.ceil(self.Player:GetVoiceVolumeScale() * 100) .. "%", "alaln-hudfontvsmall", w / 2, h / 2, Color(255, 255, 255, a), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
			end
		end
...
local SCORE_BOARD = {
	Init = function(self)
		...
		--self.NumPlayers:SetFont( "alaln-hudfontvsmall" )
