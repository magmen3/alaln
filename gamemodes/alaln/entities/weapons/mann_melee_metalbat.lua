...
SWEP.Purpose = "An old metal baseball bat, all dented and scratched. Looks like it's been used for more than just baseball."
...
SWEP.ViewModelAngleOffset = Angle(-10, 0, -3)
